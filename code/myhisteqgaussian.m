function [eqimage,ghist]=myhisteqgaussian(image, mu, sigma)
    ...
    % ---- create gaussian histogram -----
       ghist = zeros(1,maxintensity+1);
       x = [1:maxintensity+1];
       ghist = pdf('norm', x, mu, sqrt(sigma));

     % -------- create cumulative sum
       % Probability 
         tk = zeros(1,histsize);
        for i=1:histsize
            tk(1,i) = ghist(1,i)/totalpixel;
        end
